...
def validateUN(data_loader, networks, epoch, args, others):
    # set nets
    D = networks['D']
    ...
    val_dataset = others['train_dataset']
           ...
           # Just a buffer image ( to make a grid )
            ...
            for src_idx in range(len(args.att_to_use)):
                ...
                for ref_idx in range(len(args.att_to_use)):
                    ...
                    for sample_idx in range(x_ref.size(0)):
